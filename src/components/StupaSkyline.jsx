  ...
  return (
    ...
    >
      <defs>
        <g id="stupa-detail">
          {/* Plinth */}
          <rect x="-74" y="-18" width="148" height="18" rx="2" fill="#4F1222" />
          <rect x="-62" y="-30" width="124" height="12" rx="2" fill="#4F1222" />
          {/* Dome */}
          <path d="M-48,-30 C-48,-90 -28,-116 0,-116 C28,-116 48,-90 48,-30 Z" fill="#4F1222" />
          {/* All-seeing eyes */}
          ...
          {/* Harmika */}
          <rect x="-28" y="-116" width="56" height="18" rx="2" fill="#4F1222" />
          <rect x="-28" y="-134" width="56" height="4" fill="#DFA92E" />
          {/* Spire body */}
          <path d="M-12,-134 L12,-134 L4,-198 L-4,-198 Z" fill="#4F1222" />
          {/* 13 rings (tapering) */}
          ...
          {/* Prayer flag strings */}
          <path d="M-2,-204 Q-45,-176 -122,-142" fill="none" stroke="#DFA92E" strokeWidth="1.4" opacity="0.55" />
          <path d="M2,-204 Q45,-176 122,-142" fill="none" stroke="#DFA92E" strokeWidth="1.4" opacity="0.55" />
          {/* Prayer flags (left) */}
          <path d="M-30,-192 L-20,-195 L-35,-200 Z" fill="#EE7F13" />
          <path d="M-58,-179 L-48,-182 L-63,-187 Z" fill="#DFA92E" />
          <path d="M-86,-166 L-76,-169 L-91,-174 Z" fill="#4F1222" />
          ...
          <path d="M114,-153 L104,-156 L119,-161 Z" fill="#4F1222" />
        </g>
      </defs>
