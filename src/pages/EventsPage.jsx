            ...
            <div style={{ display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: 'linear-gradient(135deg, var(--saffron, #FF8A00) 0%, #e07600 100%)',
                  color: '#ffffff', border: 'none', cursor: 'pointer',
                  boxShadow: '0 4px 12px rgba(255, 138, 0, 0.3)', transition: 'all 0.2s ease',
                  whiteSpace: 'nowrap'
                }}
              ...
              return (
                <article
                  ...
                  style={{
                    ...
                    boxShadow: '0 12px 35px rgba(28, 43, 76, 0.06)', border: '1px solid rgba(226, 232, 240, 0.9)',
                    display: 'grid', gridTemplateColumns: 'minmax(320px, 460px) 1fr',
                    alignItems: 'stretch',
                    transition: 'transform 0.3s cubic-bezier(0.4, 0, 0.2, 1), box-shadow 0.3s cubic-bezier(0.4, 0, 0.2, 1)'
                  }}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.transform = 'translateY(-4px)';
                    e.currentTarget.style.boxShadow = '0 22px 45px rgba(28, 43, 76, 0.12)';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.transform = 'translateY(0)';
                    e.currentTarget.style.boxShadow = '0 12px 35px rgba(28, 43, 76, 0.06)';
                  }}
                >
                  {/* Left Column: Landscape Image Carousel Container */}
                  <div style={{ position: 'relative', width: '100%', height: '100%', minHeight: 250, aspectRatio: '16 / 9' }}>
                    ...
                    <div>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16, flexWrap: 'wrap', gap: 10 }}>
                        <span style={{
                          ...
                          background: isPast ? '#f1f5f9' : '#dcfce7', color: isPast ? '#475569' : '#15803d'
                        }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 7, color: '#64748b', fontSize: '0.88rem', fontWeight: 600 }}>
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--saffron)" strokeWidth="2.2">
                      ...
                      {ev.collaborators && ev.collaborators.length > 0 ? (
                        <div style={{ background: '#fff7ed', padding: '12px 16px', borderRadius: 14, border: '1px solid #ffedd5', marginBottom: 20 }}>
                          <div style={{ fontSize: '0.72rem', fontWeight: 800, color: 'var(--saffron)', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 8 }}>
                            🤝 {lang === 'en' ? 'In Collaboration With' : 'सहकार्यकर्ता संस्थाहरू'}
                          </div>
                          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, alignItems: 'center' }}>
                            {ev.collaborators.map((c, cIdx) => (
                              <div key={cIdx} style={{ display: 'flex', alignItems: 'center', gap: 7, background: '#ffffff', padding: '6px 14px', borderRadius: 20, border: '1px solid #fed7aa', boxShadow: '0 2px 4px rgba(0,0,0,0.02)' }}>
                                {c.logoUrl ? (
                                  <img src={c.logoUrl} alt={c.name} style={{ width: 22, height: 22, borderRadius: '50%', objectFit: 'contain' }} />
                                ) : (
                                  <span style={{ width: 8, height: 8, borderRadius: '50%', background: 'var(--saffron)' }}></span>
                                )}
                        ...
                        <div style={{ marginLeft: 'auto' }}>
                          {ev.registrationClosed ? (
                            <span style={{
                              ...
                              🔒 {lang === 'en' ? 'Registration Closed' : 'दर्ता बन्द भयो'}
                            </span>
                          ) : (
                            <a
                              ...
                              style={{
                                ...
                                boxShadow: '0 4px 14px rgba(255, 138, 0, 0.3)', transition: 'all 0.2s cubic-bezier(0.4, 0, 0.2, 1)',
                                letterSpacing: '0.02em'
                              }}
                              onMouseEnter={(e) => {
                                e.currentTarget.style.transform = 'translateY(-2px)';
                                e.currentTarget.style.boxShadow = '0 8px 22px rgba(255, 138, 0, 0.45)';
                              }}
                              onMouseLeave={(e) => {
                                e.currentTarget.style.transform = 'translateY(0)';
                                e.currentTarget.style.boxShadow = '0 4px 14px rgba(255, 138, 0, 0.3)';
                              }}
                            >
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              border: 'none', color: '#ffffff', fontSize: '2.5rem', cursor: 'pointer',
        ...
        >
          ...
          >
            ...
            <div style={{ textAlign: 'center', marginBottom: 24 }}>
              <div style={{ fontSize: '2.8rem', marginBottom: 8 }}>{isUnsubscribing ? '🔕' : '📩'}</div>
            ...
            {subMsg && (
              <div style={{ background: '#dcfce7', color: '#166534', border: '1px solid #bbf7d0', padding: '12px 16px', borderRadius: 12, fontSize: '0.88rem', fontWeight: 600, marginBottom: 16, textAlign: 'center' }}>
                🎉 {subMsg}
              </div>
            )}
              ...
              <button
                ...
                style={{
                  ...
                  background: isUnsubscribing
                    ? '#ef4444'
                    : 'linear-gradient(135deg, var(--saffron, #FF8A00) 0%, #e07600 100%)',
                  color: '#ffffff', fontWeight: 700, fontSize: '0.95rem', cursor: subscribing ? 'not-allowed' : 'pointer',
                  boxShadow: isUnsubscribing ? '0 4px 14px rgba(239, 68, 68, 0.35)' : '0 4px 14px rgba(255, 138, 0, 0.35)', transition: 'all 0.2s', marginTop: 6
                }}
              >
                {subscribing
